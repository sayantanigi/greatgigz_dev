...
-->             
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4">
                <input class="form-control" autocomplete="off" type="text" name="frm[contact_prsn_fname]" placeholder="First Name"  value="<?=$pdetail->firstname?>">
                </div>
                <div class="col-lg-4">
                <input class="form-control" autocomplete="off" type="text" name="frm[contact_prsn_lname]" placeholder="Last Name"  value="<?=$pdetail->lastname?>">
                </div>
              </div>
              <div class="form-group">
