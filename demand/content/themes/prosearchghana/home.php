...
<!--
<div class="col-md-2 col-sm-5" style="text-align:center;">
  <img src="assets/images/service/roof.png"  alt="roofing" class="imgcenter" title="Roofing" width="150" height="150"/>
  <h4 style="text-align:center">Roofing</h4>
</div>    
-->
</div>
        ...
        foreach($service as $sr){
          ...
          <div class="col-md-3 col-sm-6">
           <a href="<?=site_url('service')?>">
            <div class="img"><img src="<?=site_url('assets/images/service/'.$sr->image)?>" alt="blahblah" /></div>
