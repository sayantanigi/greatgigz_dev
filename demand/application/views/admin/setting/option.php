...
<!--div class="form-group">
   ...
   <div class="col-sm-8">
      <input type="text" name="hth4" value="<?= get_option('hth5'); ?>" placeholder="" class="form-control input-sm" />
   </div>
</div>
<div class="form-group">
   <label class="col-sm-2 control-label">Descriptionn 5</label>
   <div class="col-sm-8">
...
<div class="form-group">
   ...
   <div class="col-sm-8">
      <input type="text" name="hth4" value="<?= get_option('hth6'); ?>" placeholder="" class="form-control input-sm" />
   </div>
</div>
<div class="form-group">
