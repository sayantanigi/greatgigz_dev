    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Add Sub Service</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form action="<?=admin_url('subservice/add/'.$pages->id)?>" method="post" enctype="multipart/form-data">
          <div class="box-body">
            <div class="container">
              <div class="row">
                <div class="col-sm-10">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <select name="frm[service_id]" class="form-control">
                        <option value="">-SELECT-</option>
                        <option value="1" <?php if($pages->service_id==1){ echo "selected";} ?>>Business Owners</option>
                        <option value="2" <?php if($pages->service_id==2){ echo "selected";} ?>>Service Providers</option>
                      </select>
                    </div>
                  </div>
                </div>
