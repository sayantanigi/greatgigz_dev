                    ...
                    <div class="wrapper">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                    ...
                                    <input class="input-small" type="text"   size="16" id="dpd1"  name="check_in"  data-date-format="<?php echo $bsiCore->bt_date_format(); ?>">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                    ...
                                    <input class="input-small" type="text"   size="16" id="dpd2"  name="check_out" data-date-format="<?php echo $bsiCore->bt_date_format(); ?>">
