...
$sql=$mysqli->query("select * from bsi_invoice where booking_id=".$bsiCore->ClearInput($_REQUEST['bid']));

$r_invoice=$sql->fetch_assoc();

$sql1=$mysqli->query("select * from bsi_bookings where booking_id=".$bsiCore->ClearInput($_REQUEST['bid']));

$r_booking=$sql1->fetch_assoc();
