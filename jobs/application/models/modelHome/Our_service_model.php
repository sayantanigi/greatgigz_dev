...
class Our_service_model extends CI_Model
{
	...
	var $column_order = array(null,'our_service.title','our_service.description',null); //set column field database for datatable orderable
   // var $column_search = array('ms.country_name','md.state_name','mc.city_name','mc.status'); //set column field database for datatable searchable 
    var $order = array('our_service.id' => 'ASC'); 
        ...
        if($_POST['search']['value']) // if datatable send POST for search
            {
                ...
                {  
                    $cond  = " ";
                    $cond.=" (  our_service.title LIKE '%".trim($show_string)."%' ";
