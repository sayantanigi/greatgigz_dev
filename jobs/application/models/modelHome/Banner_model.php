...
class Banner_model extends CI_Model
{
	...
	var $column_order = array(null,'banner.heading',null); //set column field database for datatable orderable
   // var $column_search = array('ms.country_name','md.state_name','mc.city_name','mc.status'); //set column field database for datatable searchable 
    var $order = array('banner.id' => 'DESC'); 
        ...
        if($_POST['search']['value']) // if datatable send POST for search
            {
                ...
                {  
                    $cond  = " ";
                    $cond.=" (  banner.heading LIKE '%".trim($show_string)."%' ";
