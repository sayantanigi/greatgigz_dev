      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
              ...
              <a href="<?= base_url('uploads/bulk_excel/jobseeker.xlsx'); ?>" class="btn btn-danger"> Download sample format</a>
...
<div class="modal inmodal" id="uploadData" data-modal-color="lightblue" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content animated bounceInRight">
            <form  action="<?= admin_url('tableList/jobseekers/import_excel')?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body" style="padding-top: 3%">
                    ...
                    <a download class="pull-right" href="<?php echo base_url('uploads/bulk_excel/jobseeker.xlsx'); ?>" style="font-size:10px">Download Sample Format</a>
...
<!-- end import modal -->
    ...
    <script>
    var url = '<?= admin_url('tableList/jobseekers/ajax_manage_page')?>';
    var actioncolumn=5;
</script>
  ...
  function Delete(obj,cid)
{
  ...
  if(ask==true)
  {
    ...
    $.ajax({
        type:"POST",
        url:admin_url+"tableList/jobseekers/delete",
        data:datastring,
        cache:false,
