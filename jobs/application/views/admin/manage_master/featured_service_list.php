<!-- Content Wrapper. Contains page content -->
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Add Featured Service</h4>
  ...
  <!--  end add modal -->
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Edit featured service</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body">
            ...
            <form action="#" method="post" enctype="multipart/form-data">
              ...
              <div id="show_img"></div>
                ...
                <textarea class="form-control summernote" name="description12" id="edit_description"></textarea>
              </div>
              </div>
  ...
  <!--  end edit modal -->
    ...
    <script>
    var url = '<?= admin_url('manage_home/services/ajax_manage_page')?>';
    var actioncolumn=3;
</script>
