    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-md-9">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title">Use Tmeplate</h3>
              </div>
              <!-- /.card-header -->
             
                <form action="<?= admin_url('email_template/save_usetemplate')?>" method="post" enctype="multipart/form-data">
       ...
       <?php if(!empty($list_employers)){ foreach($list_employers as $key){
                       ?>
                <a href="javascript:void(0)"><label style="margin-bottom: 0; font-weight: 400;"><input type="checkbox" name="employerid[]" class="sub_childitem" value="<?= $key->userId.'_'.$key->email.'_'.$key->firstname.'_'.$key->lastname?>" onclick="return check_data();" > <?= $key->email. ' ('.ucwords($key->firstname.' '.$key->lastname).')'?></label></a>
               <?php } }?>
       ...
       <?php if(!empty($list_jobseekers)){ foreach($list_jobseekers as $key){
        ...
        ?>
               <a href="javascript:void(0)"><label style="margin-bottom: 0; font-weight: 400;"><input type="checkbox" name="jobseekerid[]" class="sub_childitem_1" value="<?= $key->userId.'_'.$key->email.'_'.$key->firstname.'_'.$key->lastname?>" onclick="return check_data1();" > <?= $key->email. ' ('.ucwords($key->firstname.' '.$key->lastname).')'?> </label></a>
               <?php } }?>
      ...
      <?php if(!empty($list_subscriber)){ foreach($list_subscriber as $key){
                ...
                ?>
              <a href="javascript:void(0)"><label style="margin-bottom: 0; font-weight: 400;"><input type="checkbox" name="subscriberid[]" class="sub_childitem_2" value="<?= $key->id.'_'.$key->email?>" onclick="return check_data2();" > <?= $key->email ?> </label></a>
               <?php } }?>
              ...
              <div class="col-md-12" style="border: 1px solid black;">
                ...
                <div class="col-md-12">
                  ...
                  <label>Employers : </label>
                   <p id="employer_list"></p>
                </div>
                <div class="col-md-12">
                   <input type="hidden" name="jobseeker_id" id="jobseeker_id" value="">
                  <label>JobSeekers :</label>
                   <p id="jobseeker_list"></p>
                </div>
                <div class="col-md-12">
                   <input type="hidden" name="subscriber_id" id="subscriber_id" value="">
                  <label>Subscribrs : </label>
                   <p id="subscriber_list"></p>
                </div>
              </div>
