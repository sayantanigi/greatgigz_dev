		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="banner-heading">Subscription Plans
						<div class="page-path"><a href="<?= base_url('')?>">Home</a> >> <span>Subscription Plans</span></div>
					</div>    
				</div>  
			</div>
		</div>
						...
						<div class="panel-body">
							...
							<div class="account-pnl">
								...
								<div class="row">
									...
									$getSubDetail=$this->Crud_model->GetData('subscription','',"id='".$key->subscription_id."'");
									//print_r($getSubDetail[0]->subscription_description);
									?>
									<div class="col-md-6 text-center">
										<div class="panel-pricing">
											...
											<div class="list-group text-center" style="margin-top: 20px;"><?= $getSubDetail[0]->subscription_description ?></div>
											<div class="panel-footer">
												<div class="display-2">
													...
													<?php } else if($key->subscription_name != '0'){?>
													<?php //if(date('Y-m-d',strtotime($key->expiry_date)) > date('Y-m-d') && $key->no_of_post > count($total_postjobs)){?>
													<?php if(date('Y-m-d',strtotime($key->expiry_date)) > date('Y-m-d')) { ?>
													<a class="btn btn-lg btn-block btn-default" href="<?= base_url('pricing')?>"> Upgrade </a> 
													<?php } else {?>
