		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="banner-heading">List of Favorite Jobs
					    	<div class="page-path"><a href="<?= base_url('')?>">Home</a> >> <span>List of Favorite Jobs</span></div>
					</div>    
				</div>  
			</div>
		</div>
  	...
  	function get_value(jobid)
  	{
  		...
  		$('#applyModal').modal('show');
  		 ...
  		 var base_url=$('#base_url').val();
  		  $.ajax({
	          type:"post",
	          url:base_url+"user/User_dashboard/get_jobseeker_resume",
	          cache:false,
	          data:{},
	          dataType:'json',
	          success:function(returndata)
	          {
	          	...
	          	$('#old_resume').val(returndata.old_resume);
	          	$('#show_resume').html(returndata.resume);
	       	 }
	    });
  	}
