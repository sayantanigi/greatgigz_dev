		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="banner-heading">List of Shortlisted Jobs
					<div class="page-path"><a href="<?= base_url('')?>">Home</a> >> <span>List of Shortlisted Jobs</span></div>
					</div>    
				</div>  
			</div>
		</div>
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td>
										<?php if($key->job_status=='shortlist'){
											echo "<h1 class='work-time part'>Short List</h1>";
										} if($key->job_status=='finalselected')
										{

											echo "<h1 class='work-time Free'>Selected</h1>";
										}
