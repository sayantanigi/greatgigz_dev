					...
					<div class="col-md-12">
						<div class="panel-body">
							...
							<div class="form-group col-md-6 p-l">
								...
								<input type="text" class="form-control" name="firstname" value="<?= @$get_jobseeker->firstname?>" onkeypress="only_alphabets(event)" autocomplete="off"/>
							</div>
							<div class="form-group col-md-6 p-r">
								<label>Last name</label>
								<input type="text" class="form-control" name="lastname" value="<?= @$get_jobseeker->lastname?>" onkeypress="only_alphabets(event)" autocomplete="off"/>
							</div>
							<div class="form-group col-md-6 p-l">
								<label>Email</label>
								<input type="text" class="form-control"name="email" value="<?= @$get_jobseeker->email?>"/>
							</div>
							<div class="form-group col-md-6 p-r">
							...
							<div class="form-group col-md-6 p-r">
								<label>Address</label>
								<input type="text" class="form-control" name="address1" id="location" oninput="getsourceaddress();" value="<?= @$get_jobseeker->address?>"/>
							</div>
							...
							<div class="form-group col-md-6 p-l">
								...
								<input type="text" class="form-control" name="job_title" value="<?= @$get_jobseeker->job_title?>"/>
							</div>
							<div class="form-group col-md-6 p-r">
									<label>Skills</label>
									<select class="form-control selectpicker" name="skill_id[]" multiple data-live-search="true" >
											<?php  $skill_id = explode(",", $get_jobseeker->skills);?>
							...
							<div class="form-group col-md-6 p-l" >
								...
								<input type="file" name="jobseeker_resume" class="form-control">
								
							</div>
							<div class="form-group col-md-6 p-r" style="margin-top: 45px;">
								<label>&nbsp;</label>
								<?php if(!empty($get_jobseeker->resume) && file_exists('uploads/jobseeker_resume/'.@$get_jobseeker->resume)){
								echo '<a href="'.base_url('uploads/jobseeker_resume/'.@$get_jobseeker->resume).'">'.@$get_jobseeker->resume.'</a>';
								 } ?>
									<input type="hidden" name="old_resume" value="<?= @$get_jobseeker->resume ?>">
							</div>
							...
							<div class="form-group col-md-6 p-l">
								...
								<input type="text" class="form-control" name="education[]" value="<?= $key->education?>" />
							</div>
							<div class="form-group col-md-6 p-l">
								<label>University / Institute</label>
								<input type="text" class="form-control" name="university_institute[]" value="<?= $key->college_name?>"/>
							</div>
							<div class="form-group col-md-6 p-l">
								<label>Grade Point Average</label>
								<input type="text" class="form-control" name="marks[]" value="<?= $key->marks?>"/>
							</div>
							<div class="form-group col-md-6 p-l">
								<label>Year</label>
								<select class="form-control" name="year[]">
                                   ...
                                   <option value="<?= $i?>"<?php if($key->passing_of_year==$i){ echo "selected";}?>><?= $i?></option>
                                         <?php } ?>
								</select>
							</div>
							 </div>
							...
							<div class="form-group col-md-6 p-l">
								<label>University / Institute</label>
								<input type="text" class="form-control" name="university_institute[]" />
							</div>
							<div class="form-group col-md-6 p-l">
								<label>Grade Point Average</label>
							...
							<div class="form-group col-md-6 p-l">
								...
								<input type="text" class="form-control" name="employer_name[]"  value="<?= $row->company_name?>" />
							</div>
							<div class="form-group col-md-6 p-l">
								<label>Status</label>
								<select class="form-control" name="status[]" >
									 <option value="Current Employer" <?php if($row->status=='Current Employer'){ echo "selected";}?>>Current Employer</option>
									 <option value="Previous Employer" <?php if($row->status=='Previous Employer'){ echo "selected";}?>>Previous Employer</option>

								</select>
							</div>
							<div class="form-group col-md-3 p-l">
								<label>Duration</label>
								<input type="date" class="form-control" placeholder="15 January 2014" name="start_date[]" value="<?= $row->from_date?>"/>
							</div>
							<div class="form-group col-md-3 p-l">
								<label>&nbsp;</label>
								<input type="date" class="form-control" placeholder="15 January 2014" name="end_date[]" value="<?= $row->to_date?>"/>
							</div>
							<div class="form-group col-md-6 p-l">
							...
							<div class="form-group col-md-12 p-l">
								...
								<textarea type="text" class="form-control" name="job_profile[]" ><?= $row->description?></textarea>
							</div>
								</div>
							<?php } } else{?>
								<div class="form-group col-md-6 p-l">
							...
							<div class="form-group col-md-3 p-l">
								<label>Duration</label>
								<input type="date" class="form-control" placeholder="15 January 2014" name="start_date[]" />
							</div>
							<div class="form-group col-md-3 p-l">
								<label>&nbsp;</label>
								<input type="date" class="form-control" placeholder="15 January 2014" name="end_date[]" />
							</div>
							<div class="form-group col-md-6 p-l">
								<label>Designation</label>
  ...
  function add_row()
  {
   ...
   function add_class()
   {
   	var html  = "";
        ...
        html += '<div class="form-group col-md-6 p-l"><label>Grade Point Average</label><input type="text" class="form-control" name="marks[]" /></div>';
