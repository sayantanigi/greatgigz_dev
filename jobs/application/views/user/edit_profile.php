									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="form-group">
												...
												<option value="Other"<?php if($getuser->organization_type=='Other'){ echo "selected";}?>>Other</option>
												</select>
									...
									<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
										...
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<div class="form-group">
												...
												<select name="state" id="state_id" class="form-control" required onchange="getcity(this.value)">
													<option value="">select State</option>
													<?php if(!empty($get_state)){ foreach($get_state as $row){?>
											   <option value="<?= $row->id?>" <?php if($getuser->state==$row->id){ echo "selected";}?>><?= ucfirst($row->name)?></option>
											  <?php } }?>
												</select>
												<div class="search_icon"><span class="ti-pin"></span></div>
											</div>
										...
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<div class="form-group">
											   ...
											   <option value="<?= $row->name ?>" <?php if($getuser->city==$row->name){ echo "selected";}?>><?= ucwords($row->name)?></option>
											  <?php } }?>
