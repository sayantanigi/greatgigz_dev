							...
							<tbody>
								<?php if(!empty($list_similarjob)){ foreach($list_similarjob as $key){
									...
									<tr>
										...
										<td><h1><?= ucwords($key->job_title)?> <p><?= ucwords(@$get_category->category_name) ?></p></h1></td>
		 ...
		 <div class="modal-content">
			 ...
			 <div class="modal-body">
              ...
              <div class="form-group">
                <label>Upload Your Resume<span id="err_resume"></span></label>
                <input class="form-control" type="file" name="resume" id="resume" >
               <!--  <br> -->
                <?php if(!empty($get_users->jobseeker_resume) && file_exists('uploads/jobseeker_resume/'.@$get_users->jobseeker_resume)){
                echo '<a href="'.base_url('uploads/jobseeker_resume/'.@$get_users->jobseeker_resume).'">'.@$get_users->jobseeker_resume.'</a>';
                 } ?>
                 <input type="hidden" name="old_resume" id="old_resume" value="<?= @$get_users->jobseeker_resume ?>">
              </div>
