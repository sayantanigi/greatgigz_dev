			...
			<div class="container">
				<div class="row">
					<div class="col-md-3">
						...
						<div class="page-heading" style="height:209px; overflow-y: scroll;">
					...
					<div class="col-md-9">
						...
						<div class="col-md-5 col-sm-5 filter p-r text-right">
							...
							<div class="col-md-5 col-sm-7 p-r">
								<div class="dropdown">
									<select class="form-control" id="sort_by" name="sort_by" style="height: 32px;">
                        <option value="">Recent Candidate</option>
                        <option value="latest_condidate">Latest Candidate</option>
                        <option value="oldest_candidate">Oldest Candidate</option>
                      </select>
								</div>
							</div>
						</div>
 ...
 return skeletonHTML;
             ...
             $.ajax({
                 ...
                 method:"POST",
                 dataType:"JSON",
                 data:{action:action, title_keyword:title_keyword,category_id:category_id, location:location,skill_id:skill_id,jobtype:jobtype,sort_by:sort_by},
