...
<body>
	<div style="width:600px;margin: 0 auto;background: #fff;font-family: 'Poppins', sans-serif; border: 1px solid #e6e6e6;">
		<div style="padding: 30px 30px 15px 30px;box-sizing: border-box;">
			...
			<p style="font-size:24px;">Hello <?= ucwords($fullname)?></p>
			...
			<a href="<?= base_url('reset-password/'.base64_encode($email))?>" style="height: 50px;
					    width: 300px;
					    ...
					    font-weight: 600;">CLICK TO RESET PASSWORD</a></p>
