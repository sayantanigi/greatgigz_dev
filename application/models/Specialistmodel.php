...
class Specialistmodel extends My_Model {
    var $column_order = array(null,'specialist.specialist_name','specialist.created_date','specialist.posted_for','specialist.status',null);
    ...
    private function _get_datatables_query($cond) {
        ...
        if($_POST['search']['value']) {
            ...
            foreach ($explode_string as $show_string) {
                ...
                $cond.=" OR specialist.posted_for LIKE '%".trim($show_string)."%' ";
