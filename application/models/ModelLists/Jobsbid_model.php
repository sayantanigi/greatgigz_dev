...
class Jobsbid_model extends My_Model
{
    ...
    var $column_order = array(null, 'job_bid_name', 'post_job_name','postjob.job_title', 'job_bid.duration', 'job_bid.bid_amount', 'job_bid.created_date', 'job_bid.bidding_status');
    ...
    {
        $this->db->select('job_bid.*,postjob.job_title,postjob.id as post_job_id,users.username,CONCAT(users.firstname,"",users.lastname) as fullname,CASE
