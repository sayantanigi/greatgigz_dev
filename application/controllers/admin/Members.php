...
class Members extends CI_Controller {
    ...
    function index() {
        $members = $this->db->query('SELECT * FROM provider_list')->result_array();
        $header = array('title' => 'Provider');
        $data = array(
            'heading' => 'Service Provider Lists',
            'members' => $members,
        );
    ...
    /*function ajax_manage_page() {
        $GetData = $this->Membersmodel->get_datatables();
