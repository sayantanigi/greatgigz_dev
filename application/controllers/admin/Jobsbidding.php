...
class Jobsbidding extends MY_Controller {
    ...
    function ajax_manage_page() {
        ...
        foreach ($GetData as $row) {
            ...
            $btn = ''.anchor(base_url('projects/postdetail/'.base64_encode($row->post_job_id)),'<span class="btn btn-sm bg-success-light mr-2"><i class="far fa-eye mr-1"></i></span>','target=_blank');
