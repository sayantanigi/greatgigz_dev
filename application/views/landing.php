    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse justify-content-end">
        <ul class="nav navbar-nav">
           <li class="nav-item">
              <a href="<?=base_url('jobs')?>" target="_blank" class="nav-link">Jobs</a>
           </li>
           <li class="nav-item">
              <a href="<?=base_url('projects')?>" target="_blank" class="nav-link">Projects</a>
          </li>
          <li class="nav-item">
            <a href="<?=base_url('demand')?>" target="_blank" class="nav-link">On Demand Services</a>
          </li>
        </ul>
      </div>
              ...
              <div class="col-sm-9 side">
                <h2 class="text-white animated-08">Recruitment portal</h2>
                  ...
                  <div class="d-flex butt">
                    <a href="<?=base_url('jobs/search-result')?>" class="btn btn-link animated-08">Find A Job <i class="fas fa-arrow-right pl-2"></i></a>
                    <a href="<?=base_url('jobs/employer-listing')?>" class="btn btn-link animated-08">Find An Employee <i class="fas fa-arrow-right pl-2"></i></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-sm-9 side">
                <h2 class="text-white animated-08">Project Posting Portal</h2>
                  ...
                  <h6 class="mb-2 font-weight-normal text-white animated-08">This is perhaps the single biggest obstacle that all of us must overcome in order to be successful.</h6>
                  <div class="d-flex butt">
                    <a href="<?=base_url('projects/ourjobs')?>" class="btn btn-link animated-08">Find A Project <i class="fas fa-arrow-right pl-2"></i></a>
                    <a href="<?=base_url('projects/workers-list')?>" class="btn btn-link animated-08">Find A Contractor <i class="fas fa-arrow-right pl-2"></i></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-sm-9 side">
                <h2 class="text-white animated-08">Service Providers Portal </h2>
                  ...
                  <h6 class="mb-2 font-weight-normal text-white animated-08">This is perhaps the single biggest obstacle that all of us must overcome in order to be successful.</h6>
                  <div class="d-flex butt">
                    <a href="<?=base_url('demand')?>" class="btn btn-link animated-08">Find A Service <i class="fas fa-arrow-right pl-2"></i></a>
                    <a href="<?=base_url('demand/create-profile')?>" class="btn btn-link animated-08">Find A Task <i class="fas fa-arrow-right pl-2"></i></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-md-4 mb-4 mb-md-0">
        <div class="feature-info feature-info-border text-center">
          ...
          <div class="feature-info-content">
            ...
            <a href="<?=base_url('jobs')?>" class="btn btn-links">Read More<i class="fas fa-arrow-right pl-2"></i></a>
          </div>
        </div>
      </div>
      <div class="col-md-4 mb-4 mb-md-0">
        <div class="feature-info feature-info-border text-center">
          ...
          <div class="feature-info-content">
            ...
            <p class="mb-0">Let success motivate you. Find a picture of what epitomizes success to you have already.</p>
            <a href="<?=base_url('projects')?>" class="btn btn-links">Read More <i class="fas fa-arrow-right pl-2"></i></a>
          </div>
        </div>
      </div>
      <div class="col-md-4 mb-4 mb-md-0">
        <div class="feature-info feature-info-border text-center">
          ...
          <div class="feature-info-content">
            ...
            <p class="mb-0">Let success motivate you. Find a picture of what epitomizes success to you have already.</p>
            <a href="<?=base_url('demand')?>" class="btn btn-links">Read More<i class="fas fa-arrow-right pl-2"></i></a>
          </div>
        </div>
      </div>
    </div>
