                ...
                <div class="col-lg-3 col-md-6 col-sm-12 column">
                    <div class="widget">
                        ...
                        <div class="link_widgets">
                            <div class="row">
                                <div class="col-lg-6">
                                    <a href="<?= base_url('projects/employer-list')?>" title="Vendors">Vendors</a>
                                    <a href="<?= base_url('projects/workers-list')?>" title="Freelancers">Freelancers</a>
                                    <a href="<?= base_url('projects/vendor_pricing')?>" title="">Vendors Pricing</a>
                                    <a href="<?= base_url('projects/freelancer_pricing')?>" title="">Freelancers Pricing</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 column">
                    <div class="widget">
                        ...
                        <div class="link_widgets">
                            <div class="row">
                                <div class="col-lg-12">
                                    <a href="<?= base_url('projects/about-us')?>" title="About us">About Us</a>
                                    <a href="<?= base_url('projects/contact-us')?>" title="Contact us">Contact Us</a>
                                    <a href="<?= base_url('projects/privacy-policy')?>" title="privacy policy">Privacy Policy</a>
                                    <a href="<?= base_url('projects/term-and-conditions')?>" title="Term & condition">Terms &
                                        Conditions </a>
                                </div>
                            </div>
                        </div>
...
if(!empty($_SESSION['commonUser']['userId'])){
    ...
    if(@$_SESSION['commonUser']['userId']==@$get_video->subscription_id && $date==date('Y-m-d') && @$get_video->status=='0'){
?>
