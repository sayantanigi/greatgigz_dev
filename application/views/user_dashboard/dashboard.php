        ...
        <div class="row row-sm">
            <div class="col-xl-12 col-lg-12 col-md-12">
                ...
                <div class="row justify-content-md-center">
                    ...
                    <?php $profile_check = $this->db->query("SELECT `profilePic`, `companyname`, `email`, `mobile`,`address`, `foundedyear`, `teamsize`, `short_bio` FROM `users` WHERE userId = '".@$_SESSION['commonUser']['userId']."'")->result_array();
                    if(empty($profile_check[0]['companyname']) || empty($profile_check[0]['email']) || empty($profile_check[0]['address']) || empty($profile_check[0]['teamsize'])  || empty($profile_check[0]['short_bio'])) { ?>
                    <div class="col-md-3 col-sm-12">
                        <a href="javascript:void(0)" onclick="completeSub()">
                            <div class="dashboard">
                ...
                <!--  end row -->
                <?php } else if($_SESSION['commonUser']['userType']==1){?>
                <!--  end employer list -->
                <!-- worker list -->
