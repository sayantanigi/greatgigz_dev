                            ...
                            <div class="col-lg-4 mb-5 mb-lg-0">
                                <div class="Sub_Block">
                                    ...
                                    if(!empty($value->product_key)) { ?>
                                        ...
                                        <?php } else { ?>
                                            <a class="btn btn-info" href="<?= base_url('paystackCheckout/'.base64_encode($value->plan_code).'/'.base64_encode($value->subscription_amount).'/'.base64_encode($_SESSION['commonUser']['userEmail']))?>">Subscribe</a>
                                        <?php } ?>
                                    <?php } else { ?>
                                    ...
                                    <input type="hidden" name="user_id_<?php echo $value->id?>" id="user_id_<?php echo $value->id?>" value="<?php echo $_SESSION['commonUser']['userId']?>">
                                    ...
                                    <input type="hidden" name="user_email_<?php echo $value->id?>" id="user_email_<?php echo $value->id?>" value="<?php echo $_SESSION['commonUser']['userEmail']?>">
