...
<body>
	<div style="width:600px;margin: 0 auto;background: #fff;font-family: 'Poppins', sans-serif; border: 1px solid #e6e6e6;">
		<div style="padding: 30px 30px 15px 30px;box-sizing: border-box;">
			...
			<h3 style="padding-top: 40px;line-height: 20px;font-weight: 100;font-size: 15px;">Greetings from<span style="font-weight: 900;font-size: 23px;color: #F44C0D;display: block;">GreatGigz</span></h3>
    		...
    		<p style="font-size: 15px; list-style: none; padding: 0; margin: 0;"><b>GreatGigz</b></p>
        ...
        <table style="width: 100%;">
        	<tr>
        		<td style="height:30px;width:100%; background: red;padding: 10px 0px; font-size:13px; color: #fff; text-align: center;">
        			Copyright &copy; <?=date('Y')?> GreatGigz. All rights reserved.
        		</td>
        	</tr>
        </table>
	</div>
