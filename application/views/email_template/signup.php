...
<body>
	<div style="width:600px;margin: 0 auto;background: #fff;font-family: 'Poppins', sans-serif; border: 1px solid #e6e6e6;">
		<div style="padding: 30px 30px 15px 30px;box-sizing: border-box;">
			...
			<h3 style="padding-top:40px; line-height: 30px;">Greetings from<span style="font-weight: 900;font-size: 35px;color: #F44C0D; display: block;">GreatGigz</span></h3>
			<p style="font-size:24px;">Hello <?php echo $fullname?>,</p>
			<p style="font-size:24px;">Thank you for registration on GreatGigz.</p>
    		...
    		<p style="list-style: none;"><b>GreatGigz</b></p>
