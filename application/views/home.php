                    ...
                    <div class="main-featured-sec">
                        ...
                        <div class="job-search-sec">
                            <div class="job-search">
                                ...
                                <form method="post" action="<?= base_url('projects/search-job')?>">
                                    <div class="row">
            ...
            <div class="row">
                    ...
                    <div class="blog-sec">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="my-blog" onclick="location.href='<?= base_url('projects/postdetail/'.base64_encode($row->id))?>';">
                ...
                <div class="col-lg-12">
                    <div class="browse-all-cat">
                        <a href="<?= base_url('projects/ourjobs')?>" title="">View More</a>
                    </div>
                </div>
                <?php } ?>
            </div>
    ...
    <div class="block Worker-Block">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading">
                        <h2>Available GreatGigz Freelancers</h2>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="my-blog">
                                    <div class="blog-thumbak">
                                        <a href="<?= base_url('projects/worker-detail/'.base64_encode(@$user->userId))?>" title="">
                                    ...
                                    <div class="blog-details">
                                        ...
                                        <h3 class="nkash">
                                            <a type="button" class="btn" href="<?= base_url('projects/worker-detail/'.base64_encode(@$user->userId))?>" title="">
                ...
                <div class="col-lg-12">
                    <div class="browse-all-cat">
                        <a href="<?= base_url('projects/workers-list')?>" title="">View More</a>
                    </div>
                </div>
                <?php } ?>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="simple-text-block">
                        ...
                        <a href="<?= base_url('projects/register')?>" title="">Create an Account</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="my-blog">
                                    <div class="blog-thumb">
                                        <a href="<?= base_url('projects/career-tip/'.base64_encode($career->id))?>" title="">
                                    ...
                                    <div class="blog-details">
                                        <h3><a href="<?= base_url('projects/career-tip/'.base64_encode($career->id))?>" title=""><?= ucfirst($career->title)?></a></h3>
                                        <div><?= ucfirst($desc)?></div>
                                        <a href="<?= base_url('projects/career-tip/'.base64_encode($career->id))?>" title=""><span>Read More</span></a>
                                    </div>
                                </div>
                            </div>
                            <?php } }?>
