					...
					<div class="col-md-12">
						<div class="panel-body">
							...
							<div class="form-group col-md-6 p-r">
								...
								<input type="file" name="company_logo" class="file form-control" required>
							...
							<div class="col-md-12 p-l">
								<div class="form-group col-md-4 p-l">
									...
									<div class="row">
													<div class="col-md-3">
													<input type="radio" name="featured_job" value="no" checked>
													No
													</div>
													<div class="col-md-3">
													<input type="radio" name="featured_job" value="yes">
													Yes
													</div>
						...
						<input type="hidden" name="employer_subscription_id" value="<?= @$get_employer->id ?>">
							<?php if(@$get_employer->no_of_post>count($total_postjobs)){?>
