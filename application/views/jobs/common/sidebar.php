...
<div class="col-md-3">
						<div class="Resume">
							<ul class="unstyled">
								...
								<li class="<?php if($seg1=='post-job'){ echo 'active';}?>"><a href="<?= base_url('post-job')?>"><i class="fa fa-caret-right"></i> Post a Jobs</a></li>

								<li class="<?php if($seg1=='my-jobs'){ echo 'active';}?>"><a href="<?= base_url('my-jobs')?>"><i class="fa fa-caret-right"></i> My Jobs</a></li>
									<li class="<?php if($seg1=='applicant-list'){ echo 'active';}?>"><a href="<?= base_url('applicant-list')?>"><i class="fa fa-caret-right"></i> Applicant List</a></li>
									<?php } ?>
									<li><a href="javascript:void(0)"><i class="fa fa-caret-right"></i> Notifications</a></li>
