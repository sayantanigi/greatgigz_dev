...
<body>
	<div style="width:600px;margin: 0 auto;background: #fff;font-family: 'Poppins', sans-serif; border: 1px solid #e6e6e6;">
		<div style="padding: 30px 30px 15px 30px;box-sizing: border-box;">
			...
			<?php } ?>
			<h3 style="padding-top:40px; line-height: 30px;">Welcome to <span style="font-weight: 900;font-size: 35px;color: #F44C0D; display: block;">phillyhire</span></h3>
			<p>Hello <?= @$fullname ?></p>
			<p>Thank you for registering on <span style="font-size:20px;"><b><?= ucwords(@$job_title)?></b></span></p>
			<p>Your have successfully an account in phillyhire website. Lets Explore together!</p>
    ...
    <p>E-mail : <span><b><?= @$email ?> </b><a href="javascript:void(0)"></a></span></p>
    	...
    	<ul style="list-style: none;padding: 0;box-sizing: border-box; margin: 4px 0;"> 
    		...
    		<li style="vertical-align: top;display: inline-block;"><b style="font-size:10px;margin-bottom: 10px;">Download the App on</b></li>
    			<li style="display: inline-block;"><a href="javascript:void(0)"><img src="<?= base_url('assets/images/playstore.png')?>" height="35px"></a></li>
    				<li style="display: inline-block;"><a href="javascript:void(0)"><img src="<?= base_url('assets/images/appstore.png')?>" style="height:35px;"></a></li>
    </ul>
