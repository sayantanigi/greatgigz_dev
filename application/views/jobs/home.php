            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="banner-content">
                        <h1>GreatGigz Job Portal</h1>
                        <p>Connecting Talent with Opportunity</p>
                    </div>
                    <div class="job-search">
                      <form method="post" action="<?= base_url('search-result')?>">
                       <div class="form-group col-md-6 padding-left b-r radius">
                           <input type="text" class="form-control" placeholder="Job title or keyword" name="search_title" />
                       ...
                       <div class="btn-search">
                           <button type="submit" class="btn btn-default"><span class="ti-search"></span> Search Job</button>
                       </div>
                       </form>
                    </div>
                </div>
