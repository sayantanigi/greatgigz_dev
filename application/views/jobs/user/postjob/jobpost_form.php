				...
				<div class="row">
					<div class="col-md-12">
						<div class="page-heading">
							...
							<p>Use the form below to post your job opening. If you have any questions or encounter any problems, please contact us at 860-437-5700.</p>
						</div>
					</div>
				</div>
				<div class="row">
						...
						<div class="panel-body">
							...
							<div class="form-group col-md-6 p-r">
								...
								<select class="form-control" name="category_id" required>
									 ...
									 <option value="<?= $cat->id?>" <?php if(@$get_postjob->category_id==$cat->id){ echo "selected";}?>><?= ucfirst($cat->category_name)?></option>
									<?php } }?>
								</select>
							</div>
							<div class="form-group col-md-6 p-l">
								<label>Job Tags <span>(Optional)</span></label>
								<input type="text" class="form-control" placeholder="eg. Designer, Developer" data-role="tagsinput" name="job_tags" value="<?= @$get_postjob->job_tags?>"/>
							</div>
							<div class="form-group col-md-6 p-r">
							...
							<textarea id="wysihtml5-editor" spellcheck="false" placeholder="Enter something ..." name="description" required><?= @$get_postjob->description ?></textarea>
								...
								<div class="form-group col-md-6 p-l">
									<label>Miximum Rate Per Hour <span>(Optional)</span></label>
							...
							<div class="form-group col-md-6 p-r">
								<label>Company Logo<span style="color:red;">*</span><span>(max. file size 3MB)</span></label>
								<input type="file" name="company_logo" class="file form-control">
