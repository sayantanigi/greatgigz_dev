            ...
            <div class="col-md-12 col-sm-12 display-table-cell v-align">
                <div class="user-dashboard">
                    <div class="row row-sm">
                        ...
                        <?php if (@$_SESSION['commonUser']['userType'] == '1' || empty(@$_SESSION['commonUser']['userType'])) { ?>
                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 col-12">
                            ...
                            <form class="bd-form" action="<?= base_url('user/dashboard/save_postbid') ?>" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="bid-btn">
                                            <?php if (!empty(@$_SESSION['commonUser']['userType'])) {
                                                if (@$_SESSION['commonUser']['userType'] == '1') {
                                                    //$userBidData = $this->db->query("SELECT * FROM `job_bid` WHERE postjob_id = '".$post_data->id."' and user_id = '".$_SESSION['commonUser']['userId']."'")->result_array();
                                                    //if(!empty($userBidData)) { ?>
