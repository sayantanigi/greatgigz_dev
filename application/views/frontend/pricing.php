    ...
    <div class="block Pricing_Data">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading">
                        <h2>Become A GreatGigz Partner Today!</h2>
                        ...
                        <div class="row subscriptionFilteredData">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                <div class="pricetable style2">
                                    ...
                                    if(!empty($_SESSION['commonUser']['userType'])) {
                                        ...
                                        <?php } else {
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <input type="hidden" name="user_id_<?php echo $key['id']?>" id="user_id_<?php echo $key['id']?>" value="<?php echo $_SESSION['commonUser']['userId']?>">
                                                ...
                                                <input type="hidden" name="user_email_<?php echo $key['id']?>" id="user_email_<?php echo $key['id']?>" value="<?php echo $_SESSION['commonUser']['userEmail']?>">
                                    ...
                                    <?php } } else { ?>
                                    <a class="btn btn-info" href="<?= base_url('projects/login')?>">Buy</a>
                                    <?php } ?>
                                </div>
                            </div>
                            <?php }} ?>
