function create_cms() {
    ...
    if(posted_for=="") {
        ...
        setTimeout(function(){$("#posted_for_err").html("&nbsp;");},3000);
        $("#posted_for").focus();
        return false;
    }
...
function update_cms() {
    ...
    if(posted_for=="") {
        $("#edit_posted_for_err").fadeIn().html("Please select an option").css('color','red');
        setTimeout(function(){$("#edit_posted_for_err").html("&nbsp;");},3000);
