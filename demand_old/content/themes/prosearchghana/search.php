<section id="banner1">
 ...
 <div class="banner-text">
  <h1>Need a <?=$service_detail->title?> You Can Rely On?</h1>
</div>
</section>
 ...
 <section class="service-detail-wrapper">
   <div class="container">
    ...
    <div class="row">
     <div class="col-sm-6">
       <div class="form-group">
         <select class="form-control"  name="frm[city]" required>
     ...
     <div class="col-sm-6">
       <div class="form-group">
         <select class="form-control" name="frm[neighbour]"> 
          <?php if(is_array($subcity) && count($subcity)>0){
            foreach ($subcity as $subc) {
              ?>
