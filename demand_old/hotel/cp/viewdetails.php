...
$viewdetailsquery = $mysqli->query("select bc.*, bb.* from bsi_bookings as bb, bsi_clients as bc where  bb.client_id=bc.client_id and booking_id=".$bookingid."");
$rowviewdetails = $viewdetailsquery->fetch_assoc();	 
?>
