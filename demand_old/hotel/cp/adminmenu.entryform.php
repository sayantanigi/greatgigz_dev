...
if(isset($_POST['Update'])){
   if(!$_POST['id']):
       $r=$mysqli->query("insert into bsi_adminmenu(name,url,ord, parent_id) values ('". $_POST['name'] ."','".$_POST['url'] ."',". $_POST['ord'].",". $_POST['parent_id'].")");	
	  // echo "insert into bsi_adminmenu(name,url,ord, parent_id) values ('". $_POST['name'] ."','".$_POST['url'] ."',". $_POST['ord'].",". $_POST['parent_id'].")";
	   $id=$mysqli->insert_id;
   else:
       $r=$mysqli->query("update bsi_adminmenu set name='".$_POST['name']."',url='".$_POST['url']."',ord=".$_POST['ord']." where id=". $_POST['id']);
	   $id=$_POST['id'];
