...
if(isset($_POST['block'])){
	...
	$bookingId       = time();
	$sql = $mysqli->query("INSERT INTO bsi_bookings (booking_id, booking_time, start_date, end_date, client_id, is_block, payment_success, block_name) values(".$bookingId.", NOW(), '".$_SESSION['sv_mcheckindate']."', '".$_SESSION['sv_mcheckoutdate']."', '0', 1, 1, '".$mysqli->real_escape_string($_POST['block_name'])."')");	
	foreach($reservationdata as $revdata){ 
		foreach($revdata['availablerooms'] as $rooms){				
		$sql = $mysqli->query("INSERT INTO bsi_reservation (bookings_id, room_id, room_type_id) values(".$bookingId.",  ".$rooms['roomid'].", ".$revdata['roomtypeid'].")");
		} 
	}	
...
<input type="hidden" name="capacity" value="1" />
          <table cellpadding="0"  cellspacing="7" border="0">
            ...
            <tr>
              ...
              <td><input id="txtFromDate" name="check_in" style="width:68px" type="text" readonly AUTOCOMPLETE=OFF />
            ...
            <tr>
              ...
              <td><input id="txtToDate" name="check_out" style="width:68px" type="text" readonly AUTOCOMPLETE=OFF />
